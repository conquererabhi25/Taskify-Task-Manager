...
const Home = () => {
  ...
  return (
    <div className="flex flex-col items-center">
      <div className="flex justify-center w-[70%] lg:w-[30%] gap-3 mt-4  flex-wrap md:flex-nowrap">
        {categories.map((eachtask) => (
          <div
            key={eachtask.id}
            onClick={() => setSelectedCategory(eachtask.type)} // update state on click
            className={`p-2 px-3 py-1 flex items-center justify-center border border-red-400 cursor-pointer shadow-md lg:w-full rounded-lg 
        ${
          ...
          >
            <p className="capitalize text-[12px] md:text-[15px]">{eachtask.type}</p>
          </div>
        ))}
      </div>
      ...
      <div className="flex flex-col lg:flex-row items-start justify-between w-full p-10 gap-4">
          ...
          {completedTaskStatus ? (
            <div className="h-[60vh] overflow-y-scroll p-2 w-full lg:w-[30%] ">
              <div className="flex w-full items-center justify-between p-2 bg-red-700 rounded-md mb-2">
                ...
                <button
                  className=" text-white rounded-full px-3 cursor-pointer py-1"
            ...
            // view Task Button 
            <div className="flex items-center justify-center shadow-md w-full md:w-[30%]  bg-red-200 p-3 rounded-md">
        ...
        {loaderShow ? (
          ...
          <div className="flex flex-col gap-4 w-full md:w-[50%]  items-center justify-start  p-2 m-2 h-[60vh] overflow-y-scroll">
            ...
            {filteredTodos.length === 0 ? (
              ...
              <>
                ...
                {filteredTodos.reverse().map((eachTodo,index) => {
                  return (
                    <div
                      key={eachTodo._id}
                    ...
                    >
                      ...
                      <div className="flex items-start justify-start p-3 w-full">
                        ...
                        <div className="w-full">
                          <div className="w-full flex items-center justify-between gap-2">
                            <h1 className="text-xs md:text-[14px] font-semibold capitalize mb-2">
                             <span>{index+1}.</span> {eachTodo.title}
                            </h1>
                            
                            <div className="flex items-center justify-center gap-2 hidden md:flex">
                              <TbCircleDotFilled
                              size={20}
                              color={getPriorityColor(eachTodo.priority)}
                                title="Priority"
                                className="border border-1 border-white rounded-full"
                            />
                              <button
                                type="button"
                          ...
                          <p className="text-xs italic capitalize mb-2">
        ...
        <div className="flex flex-col w-full md:w-[20%] items-start justify-center">
          <div className="w-full items-center justify-center p-1 text-white text-center font-semibold border border-1 border-red-400 bg-red-700 rounded-md ">
            <p>ADD TODO</p>
          </div>
          <form
